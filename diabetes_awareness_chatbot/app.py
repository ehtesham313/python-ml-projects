...
def run_streamlit():
    ...
    try:
        ...
        st.error("❌ Model artifacts (`diabetes_model.pkl`, `scaler.pkl`) not found. Please run `python train_model.py` first.")
        st.stop()
    ...
    with tab2:
        ...
        if st.button("Evaluate Diabetes Risk 🩺", type="primary"):
            ...
            if prediction == 1:
                ...
                st.success(f"✅ **LOW RISK / NORMAL**: Estimated Diabetes Probability is **{probability:.1f}%**")
